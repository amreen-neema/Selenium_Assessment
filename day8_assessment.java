...
import pomUtilities.oCandidatesPage;
import pomUtilities.oHomePage;
import pomUtilities.oLoginPage;
import pomUtilities.oRecruitmentPage;
	...
	public static void main(String[] args) throws IOException, InterruptedException  {
		// TODO Auto-generated method stub
		 BROWSER=p.getProperty("Browser");
			...
			driver.get(URL);
			Thread.sleep(2000);
			oLoginPage ol=new oLoginPage(driver);
			ol.getUser(username);
			ol.getPass(pass);
			ol.getSubmit();
			Thread.sleep(5000);
			oHomePage o=new oHomePage(driver);
			o.getRecuritment();
			oRecruitmentPage o1=new oRecruitmentPage(driver);
			o1.getAddButton();
		    ...
		    oCandidatesPage oc=new oCandidatesPage(driver);
			oc.getFn(fn);
